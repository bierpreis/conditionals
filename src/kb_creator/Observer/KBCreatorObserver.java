...
public class KBCreatorObserver implements ActionListener {
    ...
    public KBCreatorObserver() {
        ...
        statusThreadObject = new StatusThread(mainWindow.getInfoPanel(), mainWindow.getMemoryPanel());
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals("Start")) {
            ...
            creatorThreadObject = new KBCreator(mainWindow.getSignature(), mainWindow.getFilePath());
